...
@AndroidEntryPoint
class ProfileV2Fragment : BaseComposeFragment() {
            ...
            MaterialTheme {
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        item {
                            profile?.let {
                                InformationSection(userInformation)
                            }
                        }
                        item {
                            MenuSection(profile)
    ...
    @Composable
    private fun InformationSection(userInformation: List<Pair<String, String>>) {
        Card(
            modifier = Modifier.fillMaxWidth(),
            backgroundColor = AppColor.white,
